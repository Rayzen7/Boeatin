  ...
  return (
    ...
    style={{ backgroundImage: "url('/img/smk.png')" }}>
        <div className="text-center">
            <h1 className="font-[600] lg:text-[50px] text-[22px]">Selamat Datang di Forum Website Rayzen7</h1>
            <p className="font-[600] lg:text-[40px] text-[17px] lg:py-0 py-1">Produk yang Sangat Berkualitas</p>
        </div>
